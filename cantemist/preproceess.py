...
if __name__ == '__main__':
    data_test = read_data_ner("./data_set_ner/", "test")
    data_train = read_data_ner("./data_set_ner/", "train")
    data_dev = read_data_ner("./data_set_ner/", "dev")
    # data_static(data_)
    sents = data_test[1] + data_dev[1] + data_train[1]
